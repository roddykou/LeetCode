...
public:    
    SegmentTreeNode2D *buildTree(vector<vector<int>>& matrix, int tlRow, int tlCol, int brRow, int brCol) {        
    ...
    void update(SegmentTreeNode2D *node, int row, int col, int val) {
    ...
    int sumRegion(SegmentTreeNode2D *node, int tlRow, int tlCol, int brRow, int brCol) {
